...
import {Svg,Path} from "../components/html-elements"

/**
 * Props explicitas en vez de `SVGProps<SVGSVGElement>`: esa interfaz es del DOM
 * y se spreadeaba sobre el `Svg` de react-native-svg, que no la entiende.
 * Mismo patron que AuthIcons.
 */
interface IconProps {
  /** Ancho y alto en px. Default: 24. */
  size?: number;
  /** Color de relleno. Default: `currentColor` (en nativo sale negro: pasalo explicito). */
  color?: string;
  /** Clases Tailwind extra. */
  className?: string;
}

export function MoreVertIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
...
export function StorefrontIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function AllInboxIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function AccountCircleIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function ArrowBackIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={`icon ${className}`}>
      <Path fill={color} d="M20 11H7.83l5.59-5.59L12 4l-8 8l8 8l1.41-1.41L7.83 13H20z"/>
    </Svg>
  );
}

export function ShoppingCartIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function NotificationsIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function VoiceIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function NotListedLocationIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function AddLocationIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function EditLocationIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
