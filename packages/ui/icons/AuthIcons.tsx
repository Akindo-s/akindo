...
import {Svg,Path,Circle} from '../components/html-elements'
 ...
 * Ver `button.tsx` y `inputs.tsx`, mismo patron.
 */
interface IconProps {
  /** Ancho y alto en px. Default: 24. */
  size?: number;
  /** Color de relleno del trazo. Default: `currentColor`. */
  color?: string;
  /** Clases Tailwind extra. */
  className?: string;
}

export function EmailIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
...
export function PasswordIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function LogInIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
...
export function PersonAddIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
      <Circle cx="9" cy="8" r="2" fill={color} opacity="0.3"/>
...
export function AddAPhotoIcon({ size = 24, color = "currentColor", className = "" }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={`icon ${className}`}>
